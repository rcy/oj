...
import { useCreateSpaceMembershipMutation, useCreateSpaceMutation, useSharedSpacesQuery } from "../../generated-types"
...
export default function ChatSection({ pagePerson }: any) {
  ...
  const sharedSpacesQuery = useSharedSpacesQuery({ variables: { person1: pagePerson?.id, person2: myPersonId } })
