...
export const CurrentPersonFamilyMembershipDocument = gql`
  ...
  currentPerson {
    ...
    ${FamilyMembershipItemFragmentDoc}`;

/**
 * __useCurrentPersonFamilyMembershipQuery__
 *
 * To run a query within a React component, call `useCurrentPersonFamilyMembershipQuery` and pass it any options that fit your needs.
 * When your component renders, `useCurrentPersonFamilyMembershipQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCurrentPersonFamilyMembershipQuery({
 *   variables: {
 *   },
 * });
 */
export function useCurrentPersonFamilyMembershipQuery(baseOptions?: Apollo.QueryHookOptions<CurrentPersonFamilyMembershipQuery, CurrentPersonFamilyMembershipQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<CurrentPersonFamilyMembershipQuery, CurrentPersonFamilyMembershipQueryVariables>(CurrentPersonFamilyMembershipDocument, options);
      }
export function useCurrentPersonFamilyMembershipLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CurrentPersonFamilyMembershipQuery, CurrentPersonFamilyMembershipQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<CurrentPersonFamilyMembershipQuery, CurrentPersonFamilyMembershipQueryVariables>(CurrentPersonFamilyMembershipDocument, options);
        }
export type CurrentPersonFamilyMembershipQueryHookResult = ReturnType<typeof useCurrentPersonFamilyMembershipQuery>;
export type CurrentPersonFamilyMembershipLazyQueryHookResult = ReturnType<typeof useCurrentPersonFamilyMembershipLazyQuery>;
export type CurrentPersonFamilyMembershipQueryResult = Apollo.QueryResult<CurrentPersonFamilyMembershipQuery, CurrentPersonFamilyMembershipQueryVariables>;
